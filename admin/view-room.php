                                    ...
                                    <table class="table table_striped table_hover table_bordered" id="mydata">
                                        ...
                                        while ($room = mysqli_fetch_assoc($res)) {
                                            ...
                                            echo "<td>
                                                 ...
                                                 <button type=\"button\" class=\"btn btn-info view_medicine\" id=\"$room[room_id]\" onclick=\"buttonClicked(this)\" data-toggle=\"modal\" id=\"' + row[0] + '\" data-target=\"#myModal\">View</button>
            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" enctype="multipart/form-data" action="view-room.php"
                              method="post">
