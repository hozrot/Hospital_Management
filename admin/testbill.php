                  ...
                  var table  = $('#mydata').dataTable({
                      ...
                      "columnDefs": [
                          ...
                          // },
                          {
                              "targets": 3,
                              "render": function (data, type, row, meta) {
                                  return '<input class="inputs" type="text" value="0" name="discountAmount_' + row[0] + '" id="discountAmount_' + row[0] + '"onkeyup="calculateResult(this)">';
                              }
                          },
                          {
                              "targets": 4,
