...
if (isset($_POST['modal_submit'])) {
            ...
            $id = $_POST['modal_test_id'];
            $sql = "UPDATE test
                                    SET test_name='$_POST[test_name]',
...
<html>
                    ...
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" enctype="multipart/form-data" action="view-test.php"
                                      method="post">
                                    <input type="hidden" name="modal_test_id" id="modal_test_id">
                                    <div class="form-group">
                                        <label for="service_name"> Service Name </label>
                                        <input id="modal_test_name" type="text" name="test_name" class="form-control">
                                    </div>
                                   <div class="form-group">
                                        <label for="test_price"> Service Cost </label>
                                        <input id="modal_test_price" type="text" name="test_price" class="form-control">
                                    </div>
                                    <div class="form-group">
    ...
    <script type="text/javascript">
        function showData(data) {
            //console.log((data));
            $('#modal_test_id').val(data['test_id']);
             $('#modal_test_name').val(data['test_name']);
            $('#modal_test_price').val(data['test_price']);
        ...
        function buttonClicked(element) {
            ...
            $.getJSON('update/test.php', {id: attr_id}, showData);
			...
			"columnDefs": [
			{
...

                {
                    ...
                    "render": function(data, type, row, meta){
                        return '<button type="button" class="btn btn-info view_test" onclick="buttonClicked(this)" data-toggle="modal" id="' + row[0] + '" data-target="#myModal">View</button>';
                    }
                }
            ]
			} );
